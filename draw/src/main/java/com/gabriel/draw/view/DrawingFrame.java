...
import com.gabriel.draw.service.SelectImageFileService;
...
public class DrawingFrame extends JFrame {
    ...
    public DrawingFrame() {
        ...
        ActionListener selectImageAction = new SelectImageFileService(appService, this);

        drawingMenuBar = new DrawingMenuBar(actionListener);
        setJMenuBar(drawingMenuBar);
        drawingMenuBar.setVisible(true);

        drawingToolBar = new DrawingToolBar(actionListener, selectImageAction);
        drawingToolBar.setVisible(true);

        drawingView = new DrawingView(appService);
        actionListener.setComponent(drawingView);actionListener = new ActionController(appService);
        drawingMenuBar = new DrawingMenuBar( actionListener);
        setJMenuBar(drawingMenuBar);

        drawingMenuBar.setVisible(true);

        drawingToolBar = new DrawingToolBar(actionListener, drawingToolBar.selectImageAction);
        drawingToolBar.setVisible(true);
        ...
        ((DrawingCommandAppService) appService).setPropertySheet(propertySheet);
